...
def print_help() -> None:
    console.print(Panel(
        ...
        "  [cyan]/remember key: value[/cyan]  Save a fact to long-term memory (persists across sessions)\n"
        "  [cyan]/forget <keyword>[/cyan]     Remove memories matching keyword\n"
        "  [cyan]/memories[/cyan]             List all stored memories\n"
        "  [cyan]/tsave <name> <text>[/cyan]  Save a prompt template\n"
        "  [cyan]/t <name>[/cyan]             Run a saved template\n"
        "  [cyan]/templates[/cyan]            List all templates\n"
        "  [cyan]/tdelete <name>[/cyan]       Delete a template\n"
